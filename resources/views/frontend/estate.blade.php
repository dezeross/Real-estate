                            ...
                            <div class="col-xs-10 page-subheader sorting pl0">
                                <ul class="sort-by-list" >
                                    <li class="docu active" id="property-new">
                                        <a href="{{ url('bat-dong-san/moi-cap-nhat') }}" class="order_by_date" data-orderby="property_date" data-order="ASC">
                                            Mới nhất <i class="fa fa-sort-amount-asc"></i>					
                                        </a>
                                    </li>
                                    <li class="docu" id="property-price-desc">
                                        <a href="{{ url('bat-dong-san/gia-thanh-giam') }}" class="order_by_price" data-orderby="property_price" data-order="DESC">
                                            Giá giảm dần <i class="fa fa-sort-numeric-desc"></i>						
                                        </a>
                                    </li>
                                    <li class="docu" id="property-price-asc">
                                        <a href="{{ url('bat-dong-san/gia-thanh-tang') }}" class="order_by_price" data-orderby="property_price" data-order="DESC">
...
<br>
                            	 ...
                            	 <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item addClass hei">
                                        ...
                                        <div class="item-entry overflow">
                                            ...
                                            <?php $project = DB::table("tbl_project")->where("pk_project_id","=",$rows->projectid)->first(); ?>
                    ...
                    <div class="col-md-3 pl0 padding-top-40">
                        <div class="blog-asside-right pl0">
                            ...
                            <div class="panel panel-default sidebar-menu wow fadeInRight animated">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Các sản phẩm mới </h3>
                                    
                                </div>
                                <div class="panel-body recent-property-widget">
                                    <?php $new = DB::table("tbl_estate")->orderBy("pk_estate_id","desc")->take(5)->get(); ?>
                                    <ul>
