                        ...
                        <div class="section clear"> 
                            <div class="col-xs-10 page-subheader sorting pl0">
                                <ul class="sort-by-list" >
                                    <?php $project_url=$str->url_encode(strtolower($str->vn_to_str($project->c_name))); ?>
                                    <li class="docu" id="property-new">
                                        <a href="{{ url('/du-an/'.$id.'/'.$project_url.'-new') }}" class="order_by_date" data-orderby="property_date" data-order="ASC">
                                            Mới nhất <i class="fa fa-sort-amount-asc"></i>					
                                        </a>
                                    </li>
                                    <li class="docu" id="property-price-desc">
                                        <a href="{{ url('/du-an/'.$id.'/'.$project_url.'-desc') }}" class="order_by_price" data-orderby="property_price" data-order="DESC">
                                            Giá giảm dần <i class="fa fa-sort-numeric-desc"></i>						
                                        </a>
                                    </li>
                                    <li class="docu" id="property-price-asc">
                                        <a href="{{ url('/du-an/'.$id.'/'.$project_url.'-asc') }}" class="order_by_price" data-orderby="property_price" data-order="DESC">
